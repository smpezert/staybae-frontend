            ...
            <div
                ...
                <div className="flex flex-col">
                    <div className="flex flex-row justify-between relative top-28 mx-4 items-center bg-orange-600 p-4 text-white">
                        <XCircleIcon className="h-6 cursor-pointer hover:scale-105" onClick={() => setIsShowFavourites(false)} />
                        <h1 className="text-md">Favourites&nbsp;({totalFavourites})</h1>
                    </div>

                    {favourites.length === 0 && <span className="relative text-sm mt-36 m-6">You have no favourites saved</span>}
