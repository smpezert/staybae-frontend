        ...
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5'>
            <Link to={'/home'}>
                <div className="relative flex items-center h-10 cursor-pointer my-auto">
                    <img src={StayBaeLogo} alt='alt' title='StayBae' height={50} width={50} />

                    <span className="text-md md:text-4xl font-bold ml-2" title='StayBae'>StayBae</span>
                </div>
            </Link>

            <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm hover:shadow-md">
                <div className="ml-4 rounded-lg text-gray-700 text-sm cursor-pointer" title='Find a property by region' onClick={toggleRegions}>
                    Anywhere
                </div>
                <input type="text" name="search" id="searchId" className='flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400' value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder='Start your search...' />
                <MagnifyingGlassIcon className='hidden md:inline-flex h-8 bg-red-400 rounded-full p-2 text-white cursor-pointer md:mx-2' />
            </div>
            <div className="flex space-x-4 items-center justify-end" onClick={() => props.setIsShowingFavourites(true)}>
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-3 mx-auto">
                        ...
                        <div className="flex flex-col items-center">
                            <div
                                ...
                                <img src={RegionUsa} alt="USA" className="object-cover h-full hover:scale-105 cursor-pointer" />
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div
                                ...
                                <img src={RegionEu} alt="Europe" className="object-cover h-full hover:scale-105 cursor-pointer" />
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div
                                ...
                                <img src={RegionAsia} alt="Asia" className="object-cover h-full hover:scale-105 cursor-pointer" />
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div
                                ...
                                <img src={RegionAus} alt="Australia" className="object-cover h-full hover:scale-105 cursor-pointer" />
                            </div>
            ...
            {searchTerm && (
                <div className="flex flex-col col-span-3 mx-auto">
                    <DateRangePicker ranges={[selectionRange]} minDate={new Date()} rangeColors={['#FD5861']} onChange={handleSelectedDate} />

                    <div className="flex items-center border-b mb-4">
                        <h2 className="text-xl flex-grow font-semibold">Number of Guests</h2>
                        <UsersIcon className='h-5' />

                        <input type="number" id="numberOfGuests" min={1} value={numberOfGuests} onChange={(e) => setNumberOfGuests(e.target.value as unknown as number)} className='w-12 pl-2 text-lg outline-none text-red-400' />
                    </div>
